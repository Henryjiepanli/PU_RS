...
classes = CLASSES
os.makedirs("model_weights/inriabuilding/", exist_ok =True)
weights_name = "PUGNet"
...
val_dataset = InriaDataset(data_root='./train/val', mode='val', transform=get_validation_transform())
test_dataset = InriaDataset(data_root='./train/val', mode='val', transform=get_validation_transform())
