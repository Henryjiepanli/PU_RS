...
classes = CLASSES
os.makedirs("model_weights/whubuilding/", exist_ok =True)
weights_name = "PUGNet"
...
train_dataset = WHUBuildingDataset(data_root='./data/whubuilding/train', mode='train', mosaic_ratio=0.25, transform=train_aug)
